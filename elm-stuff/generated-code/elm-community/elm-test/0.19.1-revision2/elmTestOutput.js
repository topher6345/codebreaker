		...
		[
			...
			_List_fromArray(
				[
					...
					'all the same color',
					function (_v0) {
						var pick = A4($author$project$Main$Row, $author$project$Main$Red, $author$project$Main$Red, $author$project$Main$Red, $author$project$Main$Red);
						var guess = A4($author$project$Main$Row, $author$project$Main$Red, $author$project$Main$Red, $author$project$Main$Red, $author$project$Main$Red);
						var expected = {correctColor: 0, correctColorPosition: 4, empty: 0};
						var actual = A2($author$project$Main$mkFeedback, guess, pick);
						return A2($elm_explorations$test$Expect$equal, expected, actual);
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Green Green Red Red',
					function (_v1) {
						var pick = A4($author$project$Main$Row, $author$project$Main$Green, $author$project$Main$Green, $author$project$Main$Red, $author$project$Main$Red);
						var guess = A4($author$project$Main$Row, $author$project$Main$Green, $author$project$Main$Green, $author$project$Main$Yellow, $author$project$Main$Yellow);
						var expected = {correctColor: 0, correctColorPosition: 2, empty: 2};
						var actual = A2($author$project$Main$mkFeedback, guess, pick);
						return A2($elm_explorations$test$Expect$equal, expected, actual);
					}),
					A2(
					...
					function (_v2) {
						var pick = A4($author$project$Main$Row, $author$project$Main$White, $author$project$Main$Blue, $author$project$Main$White, $author$project$Main$Red);
						var guess = A4($author$project$Main$Row, $author$project$Main$Red, $author$project$Main$Red, $author$project$Main$Blue, $author$project$Main$Blue);
						var expected = {correctColor: 2, correctColorPosition: 0, empty: 2};
						var actual = A2($author$project$Main$mkFeedback, guess, pick);
						return A2($elm_explorations$test$Expect$equal, expected, actual);
					})
				])),
			...
			_List_fromArray(
				[
					...
					function (_v3) {
						var pick = A4($author$project$Main$Row, $author$project$Main$Red, $author$project$Main$Red, $author$project$Main$Red, $author$project$Main$Red);
						var guess = A4($author$project$Main$Row, $author$project$Main$Red, $author$project$Main$Red, $author$project$Main$Red, $author$project$Main$Red);
						var expected = _Utils_Tuple2(4, _List_Nil);
						var actual = A2($author$project$Main$detectCorrectPosition, guess, pick);
						return A2($elm_explorations$test$Expect$equal, expected, actual);
					})
				]))
		]));
var $author$project$Test$Generated$Main2321173728$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/christophersaunders/memory-game/tests/Example.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 294022544784525
	},
...
_Platform_export({'Test':{'Generated':{'Main2321173728':{'init':$author$project$Test$Generated$Main2321173728$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-1549.sock";
